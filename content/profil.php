...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <div class="cover">
                <img class="object-fit-cover" src="<?php echo !empty($rowUser['cover']) ? 'upload/' . $rowUser['cover'] : 'https://placehold.co/800x200' ?>" alt="" width="100%">
            </div>
        </div>
        <div class="col-sm-6">
            <div class="profile-header mt-3 ps-3 pt-5">
                <img width="100" src="<?php echo !empty($rowUser['foto']) ? 'upload/' . $rowUser['foto'] : 'https://placehold.co/100' ?>" alt="" class="rounded-circle border border-2 border-dark">
                <h2><?php echo $rowUser['nama_lengkap'] ?></h2>
                <p>@<?php echo $rowUser['nama_pengguna'] ?></p>
                <p>Deskripsi Singkat</p>
            </div>
        </div>
        <div class="col-sm-6 mt-5 pt-5" align="right">
        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="text" value="<?php echo $rowUser['nama_lengkap'] ?>" class="form-control" placeholder="Masukkan Nama Anda" name="nama_lengkap">
                    </div>
                    <div class="mb-3">
